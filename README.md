...
Version 0.5 adds evidence-based score ranges and automatic scenario comparison across overall and per-metric changes. See [CHANGELOG.md](CHANGELOG.md) for release history.
